...
*/
	...
	parser.print( 'All local packages indexed, check them with "plugin list".' );
}).help( 'Initalize local plugins description file from source.' );
